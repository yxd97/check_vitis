...
xv_boost_lib_path=/opt/xilinx/Xilinx_Vivado_vitis_2020.2/Vivado/2020.2/tps/boost_1_64_0
xvlog_opts="--relax -L axi_vip_v1_1_8 -L hbm_v1_0_9 -L xilinx_vip"
xvhdl_opts="--relax"
...
{
  file="xsim.ini"
  lib_map_path="/opt/xilinx/Xilinx_Vivado_vitis_2020.2/Vivado/2020.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
