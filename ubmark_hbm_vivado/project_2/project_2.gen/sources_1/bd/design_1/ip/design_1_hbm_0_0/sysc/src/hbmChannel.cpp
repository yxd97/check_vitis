...
using namespace sc_core;
  ...
  hbmChannel::hbmChannel(sc_core::sc_module_name nm, uint64_t memStartAddr, uint32_t memSize, std::string addrMap, unsigned hbmClk, xsc::common_cpp::report_handler* reportHandler): sc_module(nm), xtlm_aximm_target_base("target_base")
    ,wr_skt("wrSkt", 256)
    ,rd_skt("rdSkt", 256)
