...
reg   [0:0] icmp_ln34_reg_166;
reg    gmem_blk_n_W;
wire    ap_CS_fsm_state5;
reg    gmem_blk_n_B;
wire    ap_CS_fsm_state73;
wire   [0:0] icmp_ln34_fu_104_p2;
wire    ap_CS_fsm_state3;
wire   [0:0] icmp_ln34_1_fu_144_p2;
reg   [511:0] buffer_load_reg_191;
wire    ap_CS_fsm_state4;
wire   [63:0] zext_ln34_fu_139_p1;
wire  signed [63:0] sext_ln34_fu_120_p1;
reg    ap_block_state2_io;
reg    ap_block_state73;
reg   [31:0] i_fu_60;
wire   [31:0] add_ln34_fu_149_p2;
wire   [57:0] trunc_ln_fu_110_p4;
reg   [72:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state2_io) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln34_reg_166 == 1'd0))) begin
        i_fu_60 <= 32'd0;
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln34_1_fu_144_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((icmp_ln34_reg_166 == 1'd0) & (m_axi_gmem_BVALID == 1'b0))) begin
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | (~((icmp_ln34_reg_166 == 1'd0) & (m_axi_gmem_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state73)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((~((icmp_ln34_reg_166 == 1'd0) & (m_axi_gmem_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state73))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln34_reg_166 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state73) & (icmp_ln34_reg_166 == 1'd0))) begin
...
always @ (*) begin
    if ((~((icmp_ln34_reg_166 == 1'd0) & (m_axi_gmem_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state73) & (icmp_ln34_reg_166 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) & (m_axi_gmem_WREADY == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            ...
            end else if (((1'b0 == ap_block_state2_io) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln34_reg_166 == 1'd1))) begin
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln34_1_fu_144_p2 == 1'd1))) begin
...
assign add_ln34_fu_149_p2 = (i_fu_60 + 32'd1);
...
always @ (*) begin
    ap_block_state2_io = ((m_axi_gmem_AWREADY == 1'b0) & (icmp_ln34_reg_166 == 1'd0));
end

always @ (*) begin
    ap_block_state73 = ((icmp_ln34_reg_166 == 1'd0) & (m_axi_gmem_BVALID == 1'b0));
end

assign buffer_r_address0 = zext_ln34_fu_139_p1;

assign icmp_ln34_1_fu_144_p2 = ((i_fu_60 == size) ? 1'b1 : 1'b0);

assign icmp_ln34_fu_104_p2 = ((size == 32'd0) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_AWADDR = sext_ln34_fu_120_p1;
...
assign m_axi_gmem_WDATA = buffer_load_reg_191;
...
assign sext_ln34_fu_120_p1 = $signed(trunc_ln_fu_110_p4);

assign trunc_ln_fu_110_p4 = {{maxi[63:6]}};

assign zext_ln34_fu_139_p1 = i_fu_60;

endmodule //hbm_kernel_seq_write
