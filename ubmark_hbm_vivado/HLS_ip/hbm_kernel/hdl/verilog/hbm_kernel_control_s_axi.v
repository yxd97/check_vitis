...
// ==============================================================
`timescale 1ns/1ps
module hbm_kernel_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER            = 6'h08,
    ADDR_ISR            = 6'h0c,
    ADDR_MAXI_DATA_0    = 6'h10,
    ADDR_MAXI_DATA_1    = 6'h14,
    ADDR_MAXI_CTRL      = 6'h18,
    ADDR_SIZE_DATA_0    = 6'h1c,
    ADDR_SIZE_CTRL      = 6'h20,
    ADDR_PATTERN_DATA_0 = 6'h24,
    ADDR_PATTERN_CTRL   = 6'h28,
    ADDR_RANGE_R_DATA_0 = 6'h2c,
    ADDR_RANGE_R_CTRL   = 6'h30,
    WRIDLE              = 2'd0,
    WRDATA              = 2'd1,
    WRRESP              = 2'd2,
    WRRESET             = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_MAXI_DATA_0: begin
                    rdata <= int_maxi[31:0];
                end
                ADDR_MAXI_DATA_1: begin
                    rdata <= int_maxi[63:32];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_MAXI_DATA_0)
            int_maxi[31:0] <= (WDATA[31:0] & wmask) | (int_maxi[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_MAXI_DATA_1)
            int_maxi[63:32] <= (WDATA[31:0] & wmask) | (int_maxi[63:32] & ~wmask);
    end
end
