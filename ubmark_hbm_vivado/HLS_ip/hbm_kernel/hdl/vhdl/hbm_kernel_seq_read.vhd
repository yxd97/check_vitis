...
architecture behav of hbm_kernel_seq_read is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln10_reg_169 : STD_LOGIC_VECTOR (0 downto 0);
    signal gmem_blk_n_R : STD_LOGIC;
    signal ap_CS_fsm_state73 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state73 : signal is "none";
    signal icmp_ln10_1_reg_189 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln10_fu_106_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln10_1_fu_145_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state72 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state72 : signal is "none";
    signal zext_ln10_fu_150_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln10_reg_193 : STD_LOGIC_VECTOR (63 downto 0);
    signal gmem_addr_read_reg_198 : STD_LOGIC_VECTOR (511 downto 0);
    signal ap_CS_fsm_state74 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state74 : signal is "none";
    signal sext_ln10_fu_122_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state2_io : BOOLEAN;
    signal ap_predicate_op163_read_state73 : BOOLEAN;
    signal ap_block_state73 : BOOLEAN;
    signal i_fu_62 : STD_LOGIC_VECTOR (9 downto 0);
    signal add_ln10_fu_153_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal trunc_ln_fu_112_p4 : STD_LOGIC_VECTOR (57 downto 0);
    signal zext_ln10_1_fu_141_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((icmp_ln10_reg_169 = ap_const_lv1_0)) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state73) and (icmp_ln10_1_reg_189 = ap_const_lv1_0) and (icmp_ln10_reg_169 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state73) and (icmp_ln10_reg_169 = ap_const_lv1_0))) then
                    zext_ln10_reg_193(9 downto 0) <= zext_ln10_fu_150_p1(9 downto 0);
            end if;
        end if;
    end process;
    zext_ln10_reg_193(63 downto 10) <= "000000000000000000000000000000000000000000000000000000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem_RVALID, ap_CS_fsm_state2, icmp_ln10_reg_169, ap_CS_fsm_state73, icmp_ln10_1_reg_189, ap_block_state2_io, ap_predicate_op163_read_state73)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln10_reg_169 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state73;
                elsif (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln10_reg_169 = ap_const_lv1_0))) then
            ...
            when ap_ST_fsm_state73 => 
                if ((not(((ap_predicate_op163_read_state73 = ap_const_boolean_1) and (m_axi_gmem_RVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state73) and ((icmp_ln10_1_reg_189 = ap_const_lv1_1) or (icmp_ln10_reg_169 = ap_const_lv1_1)))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                elsif ((not(((ap_predicate_op163_read_state73 = ap_const_boolean_1) and (m_axi_gmem_RVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state73) and (icmp_ln10_1_reg_189 = ap_const_lv1_0) and (icmp_ln10_reg_169 = ap_const_lv1_0))) then
    ...
    add_ln10_fu_153_p2 <= std_logic_vector(unsigned(i_fu_62) + unsigned(ap_const_lv10_1));
    ...
    ap_ST_fsm_state73_blk_assign_proc : process(m_axi_gmem_RVALID, ap_predicate_op163_read_state73)
    begin
        if (((ap_predicate_op163_read_state73 = ap_const_boolean_1) and (m_axi_gmem_RVALID = ap_const_logic_0))) then 
    ...
    ap_block_state2_io_assign_proc : process(m_axi_gmem_ARREADY, icmp_ln10_reg_169)
    begin
                ap_block_state2_io <= ((icmp_ln10_reg_169 = ap_const_lv1_0) and (m_axi_gmem_ARREADY = ap_const_logic_0));
    end process;


    ap_block_state73_assign_proc : process(m_axi_gmem_RVALID, ap_predicate_op163_read_state73)
    begin
                ap_block_state73 <= ((ap_predicate_op163_read_state73 = ap_const_boolean_1) and (m_axi_gmem_RVALID = ap_const_logic_0));
    end process;


    ap_condition_756_assign_proc : process(m_axi_gmem_RVALID, ap_CS_fsm_state73, icmp_ln10_1_reg_189, ap_predicate_op163_read_state73)
    begin
                ap_condition_756 <= (not(((ap_predicate_op163_read_state73 = ap_const_boolean_1) and (m_axi_gmem_RVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state73) and (icmp_ln10_1_reg_189 = ap_const_lv1_0));
    end process;


    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, m_axi_gmem_RVALID, icmp_ln10_reg_169, ap_CS_fsm_state73, icmp_ln10_1_reg_189, ap_predicate_op163_read_state73)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or (not(((ap_predicate_op163_read_state73 = ap_const_boolean_1) and (m_axi_gmem_RVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state73) and ((icmp_ln10_1_reg_189 = ap_const_lv1_1) or (icmp_ln10_reg_169 = ap_const_lv1_1))))) then 
    ...
    ap_predicate_op163_read_state73_assign_proc : process(icmp_ln10_reg_169, icmp_ln10_1_reg_189)
    begin
                ap_predicate_op163_read_state73 <= ((icmp_ln10_1_reg_189 = ap_const_lv1_0) and (icmp_ln10_reg_169 = ap_const_lv1_0));
    end process;


    ap_ready_assign_proc : process(m_axi_gmem_RVALID, icmp_ln10_reg_169, ap_CS_fsm_state73, icmp_ln10_1_reg_189, ap_predicate_op163_read_state73)
    begin
        if ((not(((ap_predicate_op163_read_state73 = ap_const_boolean_1) and (m_axi_gmem_RVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state73) and ((icmp_ln10_1_reg_189 = ap_const_lv1_1) or (icmp_ln10_reg_169 = ap_const_lv1_1)))) then 
    ...
    buffer_r_address1 <= zext_ln10_reg_193(9 - 1 downto 0);

    buffer_r_ce1_assign_proc : process(ap_CS_fsm_state74)
    begin
    ...
    buffer_r_d1 <= gmem_addr_read_reg_198;
    ...
    gmem_blk_n_AR_assign_proc : process(m_axi_gmem_ARREADY, ap_CS_fsm_state2, icmp_ln10_reg_169)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln10_reg_169 = ap_const_lv1_0))) then 
    ...
    gmem_blk_n_R_assign_proc : process(m_axi_gmem_RVALID, icmp_ln10_reg_169, ap_CS_fsm_state73, icmp_ln10_1_reg_189)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state73) and (icmp_ln10_1_reg_189 = ap_const_lv1_0) and (icmp_ln10_reg_169 = ap_const_lv1_0))) then 
    ...
    icmp_ln10_1_fu_145_p2 <= "1" when (zext_ln10_1_fu_141_p1 = size) else "0";
    icmp_ln10_fu_106_p2 <= "1" when (size = ap_const_lv32_0) else "0";
    m_axi_gmem_ARADDR <= sext_ln10_fu_122_p1;
    ...
    m_axi_gmem_ARVALID_assign_proc : process(ap_CS_fsm_state2, icmp_ln10_reg_169, ap_block_state2_io)
    begin
        if (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln10_reg_169 = ap_const_lv1_0))) then 
    ...
    m_axi_gmem_RREADY_assign_proc : process(m_axi_gmem_RVALID, ap_CS_fsm_state73, ap_predicate_op163_read_state73)
    begin
        if ((not(((ap_predicate_op163_read_state73 = ap_const_boolean_1) and (m_axi_gmem_RVALID = ap_const_logic_0))) and (ap_predicate_op163_read_state73 = ap_const_boolean_1) and (ap_const_logic_1 = ap_CS_fsm_state73))) then 
    ...
    trunc_ln_fu_112_p4 <= maxi(63 downto 6);
    zext_ln10_1_fu_141_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_fu_62),32));
    zext_ln10_fu_150_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_fu_62),64));
end behav;
